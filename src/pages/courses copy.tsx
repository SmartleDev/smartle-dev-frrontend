     ...
     {learner === null && <div className="flex flex-wrap justify-center w-10/12 mx-auto">
      ...
      </div>
      {
        (!isNull(courses) && courses && updateCourses) && (
          ...
          <Link to={`/course/${course.course_name}`} className="mx-5 md:mx-0 my-10 relative text-slate-900 bg-accent-200 p-5 shadow-xl rounded-lg flex flex-wrap " onClick={()=> fetchCourseID(course.course_id)}>                
