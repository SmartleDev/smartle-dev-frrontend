    ...
    return (
      <div className="home-page">
        ...
        <h2 className="text-4xl pb-10 font-black">
          {myCourses.length === 0
            ? 'Explore and Get the Right Course'
        ...
        >
          {myCourses.length === 0 ? (
            ...
            >
              <h1
                className="text-2x2 m-2 font-black"
                style={{
                  display: 'flex',
        ...
        <div className="recommendation">
          ...
          <h2 className="text-4xl pb-10 font-black section_heading">
          ...
          {topLearners?.map((dataItem: any, index: number) => (
            <div>
              ...
              <div
                ...
                className="p-2 relative"
              >
                <p className="text-2x2 m-2 font-black">
                  {dataItem.course_name}
                </p>
                <p>{dataItem?.course_description}</p>
              </div>
