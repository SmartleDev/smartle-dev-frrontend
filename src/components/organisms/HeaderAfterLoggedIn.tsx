...
import routes from '../../util/routes/routesAfterLogin';
...
const HeaderAfterLoggedIn = () => {
    ...
    // }
    return (
        <div className="bg-transparent pt-1 z-80" style={{marginTop: "0px"}}>
                    ...
                    <Link to="/" className={`hidden dark:block  ${isMobile ? 'text-xl pt-3 pl-1' : 'text-2xl px-8 py-1 shadow-none rounded-sm'}`}>
                         {
                            location.pathname !== '/courses' ? (
                                <img className='w-32' src={smartlelogo1} alt="" />
                            ) : (
                                <img className='w-32' src={smartlelogo1} alt="" />
                            )
                        }
...
export default HeaderAfterLoggedIn;